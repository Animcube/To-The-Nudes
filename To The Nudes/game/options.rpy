...
init -1 python hide:
    ...
    config.window_title = u"To The Nudes"

    # Эти управляют именем и версией игры, которые указываются
    # в журналах отладки.
    config.name = "To The Nudes"
    config.version = "0.000"
    ...
    theme.diamond(
        ...
        widget_selected = "#ebde55",

        ## The color of a disabled widget face.
        disabled = "0b6693",

        ## The color of disabled widget text.
        disabled_text = "0b6693",
        ...
        mm_root = "main_menu.png",

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "main_menu.png",
...
python early:
    config.save_directory = "To The Nudes-1498941698"
